...
2.	A persistent access token. You can generate one from the [Trading Station web](https://tradingstation.fxcm.com/) Click on User Account > Token Management on the upper right hand of the website.
